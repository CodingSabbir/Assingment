...
const Detailes = (props) => {
    ...
    return (
        <>
                ...
                <div class="  container mx-auto px-2  border-2 md:px-3 my-2 relative flex w-full max-w-[26rem] flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
